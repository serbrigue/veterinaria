...
class MascotaController extends Controller
{
    ...
    public function crear(GuardarMascotaRequest $solicitud)
    {
        ...
        if ($solicitud->hasFile('foto')) {
            $data['imagen_url'] = $this->procesarFoto($solicitud, 'foto', 'mascotas/fotos');
        }
    ...
    public function actualizar(ActualizarMascotaRequest $solicitud, Mascota $mascota)
    {
        ...
        if ($solicitud->hasFile('foto')) {
            $data['imagen_url'] = $this->procesarFoto($solicitud, 'foto', 'mascotas/fotos', $mascota->imagen_url);
        }
    ...
    {
        $this->eliminarFotoFisica($mascota->imagen_url);
