            ...
            <div class="card shadow border-0 overflow-hidden rounded-4">
                <div class="row g-0">
                    ...
                    <div class="col-md-5 col-lg-4 position-relative p-0" style="min-height: 300px;">
                        <img :src="box.imagen_url || '/images/default_box.png'" class="w-100 h-100 object-fit-cover position-absolute top-0 start-0" alt="Imagen del box" />
                        ...
                        <div class="position-relative z-1 h-100 d-flex flex-column align-items-center justify-content-center text-white p-5">
                            <h2 class="h3 fw-bold text-center text-shadow mb-3">{{ box.nombre }}</h2>
                            <span class="badge bg-primary shadow-sm fs-6 px-3 py-2">ID: #{{ box.id }}</span>
                        </div>
                    </div>
