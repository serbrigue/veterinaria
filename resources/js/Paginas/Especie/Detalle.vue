        ...
        <div class="container py-4">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
                    <h1 class="h4 mb-0 text-primary fw-bold">Detalle de la Especie</h1>
                </div>
                ...
                <div class="card-body">
                    <div class="row g-4 align-items-center">
                        <div class="col-12 col-md-7 col-lg-8">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item px-0 py-3">
                                    ...
                                    <p class="mb-0 fw-semibold">#{{ especie.id }}</p>
                                </li>
                                <li class="list-group-item px-0 py-3">
                                    <h6 class="text-muted mb-1 small">Nombre de la Especie</h6>
                                    <p class="mb-0 fs-5">{{ especie.nombre }}</p>
                                </li>
                                <li class="list-group-item px-0 py-3">
                                    <h6 class="text-muted mb-1 small">Descripción</h6>
                                    <p class="mb-0">{{ especie.descripcion }}</p>
                                </li>
                                <li class="list-group-item px-0 py-3">
                                    <div class="d-flex flex-wrap gap-4">
                                        <div>
                                            <h6 class="text-muted mb-1 small">Creada en</h6>
                                            <p class="mb-0 small">{{ new Date(especie.created_at).toLocaleDateString() }}</p>
                                        </div>
                                        <div>
                                            <h6 class="text-muted mb-1 small">Última Actualización</h6>
                                            <p class="mb-0 small">{{ new Date(especie.updated_at).toLocaleDateString() }}</p>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="col-12 col-md-5 col-lg-4 text-center">
                            <div v-if="especie.imagen_url" @click="abrirModalImagen(especie)" class="p-2 border rounded bg-light" style="cursor: pointer; max-width: 100%; margin: 0 auto;">
                                <img 
