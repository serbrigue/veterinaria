                ...
                <div class="col-lg-4 col-md-5">
                    <div class="card border-0 shadow-sm sticky-top" style="top: 2rem;">
                        <div class="card-body text-center py-4">
                            <div v-if="mascota.imagen" class="mx-auto mb-3" style="width: 100px; height: 100px;">
                                <img :src="mascota.imagen" alt="Foto de la mascota" class="img-fluid rounded-circle object-fit-cover w-100 h-100 border shadow-sm">
                            </div>
                        ...
                        <div class="card-body border-top p-4 bg-light bg-opacity-50">
                            ...
                            <div class="d-flex align-items-start gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <Link v-if="mascota.cliente" :href="route('clientes.detalle', mascota.cliente_id)" class="text-decoration-none fw-bold text-primary hover-primary">
                                        {{ mascota.cliente.nombre }} <i class="bi bi-box-arrow-up-right ms-1 small"></i>
                                    </Link>
                            ...
                            <div class="d-flex align-items-start gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <span class="text-dark fw-medium d-block">
                                        {{ mascota.especie?.nombre || 'Especie N/A' }} 
                                        <span class="text-muted mx-1">•</span> 
                                        {{ mascota.raza?.nombre || 'Raza N/A' }}
                                    </span>
                                </div>
                            </div>
